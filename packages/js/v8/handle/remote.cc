...
auto remote_handle::expire::dispatch(remote_handle* pointer, util::derived_delete<remote_handle> delete_) const noexcept -> void {
	auto handle = expired_remote_type{pointer, delete_};

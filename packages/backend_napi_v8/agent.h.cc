...
struct agent_handle_value::clock_deterministic {
		...
		constexpr static auto variant = js::discriminated_alternative{util::cw<"type">, util::cw<"deterministic">};
...
struct agent_handle_value::clock_microtask {
		...
		constexpr static auto variant = js::discriminated_alternative{util::cw<"type">, util::cw<"microtask">};
		constexpr static auto struct_template = js::struct_template{
...
struct agent_handle_value::clock_realtime {
		...
		constexpr static auto variant = js::discriminated_alternative{util::cw<"type">, util::cw<"realtime">};
		constexpr static auto struct_template = js::struct_template{
...
struct agent_handle_value::clock_system {
		constexpr static auto variant = js::discriminated_alternative{util::cw<"type">, util::cw<"system">};
		constexpr static auto struct_template = js::struct_template{};
};

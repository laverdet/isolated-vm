...
// undefined & null
auto accept_basic_napi_value::operator()(undefined_tag /*tag*/, visit_holder /*visit*/, std::monostate /*subject*/) const -> napi::value<undefined_tag> {
	return value<undefined_tag>::from(napi::invoke(napi_get_undefined, napi_env{*this}));
}

auto accept_basic_napi_value::operator()(null_tag /*tag*/, visit_holder /*visit*/, std::nullptr_t /*subject*/) const -> napi::value<null_tag> {
	return value<null_tag>::from(napi::invoke(napi_get_null, napi_env{*this}));
}

// boolean
auto accept_basic_napi_value::operator()(boolean_tag /*tag*/, visit_holder /*visit*/, bool subject) const -> napi::value<boolean_tag> {
	return value<boolean_tag>::from(napi::invoke(napi_get_boolean, napi_env{*this}, subject));
}

// number
auto accept_basic_napi_value::operator()(number_tag_of<double> /*tag*/, visit_holder /*visit*/, double subject) const -> napi::value<number_tag_of<double>> {
	return value<number_tag_of<double>>::from(napi::invoke(napi_create_double, napi_env{*this}, subject));
}

auto accept_basic_napi_value::operator()(number_tag_of<std::int32_t> /*tag*/, visit_holder /*visit*/, std::int32_t subject) const -> napi::value<number_tag_of<std::int32_t>> {
	return value<number_tag_of<std::int32_t>>::from(napi::invoke(napi_create_int32, napi_env{*this}, subject));
}

auto accept_basic_napi_value::operator()(number_tag_of<std::uint32_t> /*tag*/, visit_holder /*visit*/, std::uint32_t subject) const -> napi::value<number_tag_of<std::uint32_t>> {
	return value<number_tag_of<std::uint32_t>>::from(napi::invoke(napi_create_uint32, napi_env{*this}, subject));
}
...
auto accept_basic_napi_value::operator()(string_tag_of<char> /*tag*/, visit_holder /*visit*/, std::string_view subject) const
	...
	return js::referenceable_value{napi::value<string_tag_of<char>>::from(value)};
}
...
auto accept_basic_napi_value::operator()(string_tag_of<char8_t> /*tag*/, visit_holder /*visit*/, std::u8string_view subject) const
	...
	return js::referenceable_value{napi::value<string_tag_of<char8_t>>::from(value)};
}
...
auto accept_basic_napi_value::operator()(string_tag_of<char16_t> /*tag*/, visit_holder /*visit*/, std::u16string_view subject) const
	...
	return js::referenceable_value{napi::value<string_tag_of<char16_t>>::from(value)};
}
...
auto accept_basic_napi_value::operator()(bigint_tag_of<std::int64_t> /*tag*/, visit_holder /*visit*/, std::int64_t subject) const
	...
	return js::referenceable_value{napi::value<bigint_tag_of<std::int64_t>>::from(value)};
}
...
auto accept_basic_napi_value::operator()(bigint_tag_of<std::uint64_t> /*tag*/, visit_holder /*visit*/, std::uint64_t subject) const
	...
	return js::referenceable_value{napi::value<bigint_tag_of<std::uint64_t>>::from(value)};
}
...
auto accept_basic_napi_value::operator()(bigint_tag_of<js::bigint> /*tag*/, visit_holder /*visit*/, const js::bigint& subject) const
	...
	return js::referenceable_value{napi::value<bigint_tag_of<js::bigint>>::from(value)};
}
...
auto accept_basic_napi_value::operator()(date_tag /*tag*/, visit_holder /*visit*/, js_clock::time_point subject) const
	...
	auto value = napi::value<date_tag>::from(napi::invoke(napi_create_date, napi_env{*this}, subject.time_since_epoch().count()));
...
auto accept_basic_napi_value::operator()(error_tag /*tag*/, visit_holder visit, const js::error_value& subject) const
	...
	auto* message = napi_value{js::transfer_in<napi::value<string_tag>>(subject.message(), environment())};
...
auto accept_basic_napi_value::operator()(array_buffer_tag /*tag*/, visit_holder /*visit*/, const js::array_buffer& subject) const
	...
	auto value = napi::value<array_buffer_tag>::from(result);
	return js::referenceable_value{value};
}
...
auto accept_basic_napi_value::operator()(shared_array_buffer_tag /*tag*/, visit_holder /*visit*/, js::shared_array_buffer&& subject) const
	...
	auto value = napi::value<shared_array_buffer_tag>::from(std::bit_cast<napi_value>(shared_array_buffer));
	return js::referenceable_value{value};
}

...
// remote_handle_lock
remote_handle_lock::remote_handle_lock(remote_handle_list& list, std::weak_ptr<reset_handle_type> expiry_scheduler_) :
		list_{list},
		expiry_scheduler_{std::move(expiry_scheduler_)} {}

// remote_handle
remote_handle::remote_handle(v8::Global<v8::Data> handle, std::weak_ptr<reset_handle_type> reset) :
